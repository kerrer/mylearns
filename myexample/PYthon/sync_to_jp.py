...
flag = "JP"
image_root= "/images/"
zh_images_host = "http://images.speed-trade.com.cn"
rpc_items_uri = "http://xiangce.speed-trade.com/images/setSyncJp/.json"
rpc_file_uri = "http://xiangce.speed-trade.com/files/setSyncJp/.json"
DB_HOST= "localhost"
DB_USER= "caimgpd"
...
SELECT_IMAGES_QUERY="select * from Item_Images where imgz_s=1 and imgj_s=0 and status = 1 limit %d"
UPDATE_IMAGE_QUERY="UPDATE Item_Images SET imgj_s = 1 WHERE id = %d"
SELECT_FILES_QUERY="select * from Files where  status = 1 and imgz_s=1 and imgj_s=0  limit %d"
UPDATE_FILE_QUERY="UPDATE Files SET imgj_s = 1 WHERE id = %d"
